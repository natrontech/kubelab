<script lang="ts">
  ...
  import Cta from "$lib/components/landingpage/Cta.svelte";
  ...
  import type { CompaniesResponse, FaqsResponse, PlansResponse } from "$lib/pocketbase/generated-types";

  export let data: any;

  let plans: PlansResponse[] = data?.plans ?? [];
